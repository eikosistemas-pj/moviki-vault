...
- **Material de apoio (24/09/2026):** 91 peças, 16 categorias. No topo do menu do parceiro, três cartões: "Para qualquer negócio", "Panfletos com o seu QR" (panfletos A5) e "Chamar parceiro"; ramo novo "Lojas de shopping" (vídeos de live de moda, calçados/esportes e pet, feitos com a skill `video-shopping`). Legenda de peça que cita recurso só do Enterprise (Pix dentro da live, oferta relâmpago com contagem, estoque ao vivo, cupom, brinde, cortes) diz que é do Enterprise. Com `LIVE_NA_PAGINA` desligado o robô social só tinha 11 peças de feed, 11 de story e 1 de reel; ligado, 30, 33 e 4.
