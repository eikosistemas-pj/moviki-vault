...
## Por que agora
**É o único bloqueio crítico em aberto do projeto.** Com a LGPD do Vik fechada em 28/08, não sobrou mais nada de produto ou de conformidade travando: o produto está pronto, o funil está medido de ponta a ponta (GA4 + CAPI) e as landings estão em conformidade. Falta trazer gente.
...
| --- | --- |
| 2026-08-28 | Prazo definido: 2026-09-04. Passou a ser o único bloqueio crítico do projeto. |
